...
pub(crate) fn contract_revision_digest(
    contract_id: &str,
    revision: i64,
    state: &str,
    source_yaml: &str,
...
pub(crate) fn map_contract_revision_row(
    row: &rusqlite::Row<'_>,
) -> rusqlite::Result<ContractRevisionRecord> {
...
pub(crate) fn contract_run_digest(input: &RecordContractRunInput, created_at_ms: i64) -> String {
...
#[allow(clippy::too_many_arguments)]
pub(crate) fn contract_stop_digest(
    contract_id: &str,
    revision: i64,
    run_id: Option<&str>,
    task_id: Option<&str>,
...
pub(crate) fn map_contract_stop_row(
    row: &rusqlite::Row<'_>,
) -> rusqlite::Result<ContractStopRecord> {
...
pub(crate) fn contract_verdict_digest(
    run_id: &str,
